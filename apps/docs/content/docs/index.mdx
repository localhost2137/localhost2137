...
persistence.
[Provider compatibility](/compatibility) explains how to read that service as a set of bounded,
versioned claims rather than a local copy of an entire provider.
